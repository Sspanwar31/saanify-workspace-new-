  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-900 mt-6">
      <Card className="rounded-xl border-gray-200 dark:border-gray-800 shadow-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100">
        <CardHeader>
          <CardTitle className="text-gray-900 dark:text-gray-200">Maturity Projections - Fixed Columns</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <Table>
              <TableHeader className="sticky top-0 bg-white dark:bg-gray-950 z-10 shadow-sm border-b border-gray-200 dark:border-gray-800">
                <TableRow>
                  ...
                  <TableHead className="text-gray-900 dark:text-gray-300">Join Date</TableHead>
                  <TableHead className="text-gray-900 dark:text-gray-300">Current Deposit</TableHead>
                  <TableHead className="text-gray-900 dark:text-gray-300">Target Deposit</TableHead>
                  <TableHead className="text-gray-900 dark:text-gray-300">Projected Int.</TableHead>
                  <TableHead className="text-gray-900 dark:text-gray-300">Maturity Amount</TableHead>
                  <TableHead className="text-gray-900 dark:text-gray-300">Outstanding Loan</TableHead>
                  <TableHead className="text-right text-gray-900 dark:text-gray-300">Net Payable</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {data.length === 0 ? (
                  ...
                  data.map((maturity: any, i: number) => (
                    <TableRow key={i} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors border-b border-gray-200 dark:border-gray-800">
                      ...
                      <TableCell className={`text-right font-bold ${maturity.netPayable >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
