...
export default function ChristmasCinematicIntro({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    ...
    const spawn = (): Particle => {
      ...
      const phaseConfig = {}; // Cleaned placeholder

      let currentDirection = 'downward';
      let currentSpawnY    = -0.1;
      let currentMinSize   = 0.8;
      let currentMaxSize   = 2.5;
      ...
      let baseMaxLife = Math.max(350, Math.floor(h / (currentSpeed * 0.8)));
