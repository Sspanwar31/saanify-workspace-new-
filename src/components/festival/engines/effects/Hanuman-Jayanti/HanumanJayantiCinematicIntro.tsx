...
export default function HanumanJayantiCinematicIntro({ onComplete, imageUrl }: Props) {
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     🎬 10.5s TIMELINE (same as Ganesh):
     0.0s - 1.5s  → धुएं और ऊर्जा का प्रवेश (सस्पेंस)
     1.5s - 4.5s  → भगवान हनुमान का स्वर्णिम प्रकटीकरण
     4.5s - 8.0s  → आरती, घंटियाँ, फूलों की सघन वर्षा
     8.0s - 9.8s  → "Happy Hanuman Jayanti" + श्लोक प्रकटीकरण
     9.8s - 10.5s → स्वाभाविक फेड-आउट हैंडओवर
   ═══════════════════════════════════════════════════════════════ */
  useEffect(() => {
    if (!imgReady) return;
    ...
    /* ─────────────────────────────────────────────
       BACKGROUND — warm-up starts at 0s, full by 1.5s
       ───────────────────────────────────────────── */
    ...
    /* ─────────────────────────────────────────────
       TEMPLES — fade starts 8.5s, gone by ~9.8s
       ───────────────────────────────────────────── */
    ...
    /* ─────────────────────────────────────────────
       DUST — always active ambient particles
       ───────────────────────────────────────────── */
    ...
    /* ─────────────────────────────────────────────
       ENERGY — Phase 1: 0-1.5s suspense pulse
    ...
    /* ─────────────────────────────────────────────
       BELLS — 4.5s to 8.0s (aarti phase)
       ───────────────────────────────────────────── */
    ...
    /* ═══════════════════════════════════════════════════════════════
       🖼️ HANUMAN IMAGE — 3 phases (same logic as Ganesh)
    ...
    function dHanuman(t: number) {
      ...
      // Phase 1: 1.5s - 4.5s — Golden ring circular reveal
      if (t >= 1.5 && t < 4.5) {
    ...
    /* ─────────────────────────────────────────────
       BLOOM — 6.5s burst (mid-aarti phase)
       ───────────────────────────────────────────── */
    ...
    /* ─────────────────────────────────────────────
       DISSOLVE GLOW — 7.5s+ (हनुमान जी के फ़ेड-आउट के साथ)
       ───────────────────────────────────────────── */
    ...
    /* ═══════════════════════════════════════════════════════════════
       ...
       ── shadowBlur हटाया → Crisp Offset Shadow तकनीक (same as Ganesh)
       ═══════════════════════════════════════════════════════════════ */
    function dText(t: number) {
      ...
      const tw = c!.measureText('Happy Hanuman Jayanti').width;

      // ── 1. क्रिस्प डार्क ड्रॉप शैडो (बिना किसी ब्लर के - 2px Offset) ──
      c!.fillStyle = 'rgba(0, 0, 0, 0.72)';
      c!.fillText('Happy Hanuman Jayanti', W / 2 + 2, ty + 3);
      ...
      c!.fillStyle = mg;
      c!.fillText('Happy Hanuman Jayanti', W / 2, ty);
    ...
    const loop = (ts: number) => {
      ...
      // Background layers (always)
      dBg(t); dTemples(t); dSmoke(); dRays(t); dDust(t);

      // Aarti phase effects (4.5s+)
