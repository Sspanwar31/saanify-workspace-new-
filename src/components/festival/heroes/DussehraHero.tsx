  ...
  return (
    ...
    >
      ...
      {posterUrl && !imgError ? (
        ...
        <div className="relative w-full max-w-[260px] aspect-[3/4] rounded-2xl overflow-hidden border-2 border-amber-500/50 shadow-[0_15px_50px_rgba(251,191,36,0.45)] backdrop-blur-sm">
          <img 
            src={posterUrl} 
            alt="Dussehra" 
        ...
        /* 🏹 OPTION B: 2027 ULTRA-REALISTIC 3D GOLDEN BOW & BLAZING ARROW */
        <div className="relative z-10 w-full max-w-[300px] sm:max-w-[360px] flex items-center justify-center filter drop-shadow-[0_15px_45px_rgba(255,140,0,0.75)]">
          <svg viewBox="0 0 240 220" className="w-full h-auto overflow-visible">
            <defs>
              ...
              {/* 3. Advanced Cinematic Glow Filter */}
            ...
            <g style={{ transformOrigin: '120px 105px', animation: 'float-y 4s ease-in-out infinite' }} filter="url(#ultraDussehraGlow)">
              ...
              {/* 3D Highlight on Bow (Specular Shine) */}
              ...
              {/* 2. BLAZING FIRE ARROW (Pointing UP ↑) */}
              {/* Arrow Shaft (Gold) */}
              ...
              {/* Arrowhead (Agnibaana - Sharp & Majestic) */}
            ...
            {/* ✨ FLOATING EMBERS & SPARKS (Organic Animation) */}
