...
import { useSuperClientStore, Member, PassbookEntry } from '@/lib/super-client/store';
...
export default function PassbookAddEntryModal({ isOpen, onClose }: PassbookAddEntryModalProps) {
  const { 
    members, 
    loans, 
    addPassbookEntry, 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold">Add Passbook Entry</DialogTitle>
        </DialogHeader>
