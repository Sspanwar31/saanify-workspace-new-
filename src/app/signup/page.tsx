...
try {
  ...
  if (selectedPlanId !== 'TRIAL') {
      const { error: payError } = await supabase
        ...
        .insert([{
            client_id: authData.user.id, // Linking to the newly created client
            plan_name: currentPlan.name, // e.g. "Professional"
            amount: currentPlan.price,
            payment_method: 'MANUAL', // Matches schema enum
      ...
      if (payError) {
          ...
          // Not throwing here to avoid breaking signup flow, but logging it
      }
  }
